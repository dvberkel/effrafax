...
public enum BowlFactory {
	 ...
	 *  
	 * @param <S> The generic class of the provider.
	...
	private <S> S getInstance(Class<S> service) {
		...
		throw new IllegalStateException(
				"No provider registered for service " + service.toString()
		);
	}
	 ...
	 * 
	 * @param owner The {@code Player} who will own the {@code Bowl}.
	 ...
	 * 
	 * @param owner The {@code Player} who will own the {@code Bowl}.
	 * @param numberOfStones The number of stones the {@code Bowl} will contain.
	 * @return An empty {@code Bowl} owned by {@code player}.
	 */
	 ...
	 * 
	 * @param owner The {@code Player} who will own the {@code Kalaha}.
	 ...
	 * 
	 * @param owner The {@code Player} who will own the {@code Kalaha}.
	 * @param numberOfStones The number of stones the {@code Kalaha} will contain.
	 * @return An empty {@code Kalaha} owned by {@code player}.
	 */
